...
S.views = {
    ...
    "product-detail-view": (container) => renderProductDetailPage(container),
    "cart-view": (container) => renderCartPage(container),
    "checkout-view": (container) => renderCheckoutPage(container),
    "profile-view": (container) => renderProfilePage(container),
    "orders-view": (container) => renderOrdersPage(container),
    "order-detail-view": (container) => renderOrderDetailPage(container),
    "cancellation-success-view": (container) => renderCancellationSuccessPage(container),
    "search-view": (container) => renderSearchPage(container),
    "search-results-view": (container) => renderSearchResultsPage(container),
